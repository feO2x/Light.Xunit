...
public sealed class TestSettingsTests
{
    ...
    {
        Environment.SetEnvironmentVariable("Xunit_TestVariable", "Foo", EnvironmentVariableTarget.Process);

        File.WriteAllText("testsettings.json", "{ \"testConfiguration\": { \"loadEnvironmentVariables\": true, \"environmentVariablesPrefix\": \"Xunit_\" }, \"theValue\": \"Foo\" }");
